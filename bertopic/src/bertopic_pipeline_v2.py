...
try:
    from shared_state_normalization import (
        CANONICAL_STATES, STATE_ALIASES, canonicalize_state,
    )
except ImportError as e:
    sys.exit(f"[FATAL] Could not import shared_state_normalization.py from repo root: {e}")
...
# CANONICAL_STATES / STATE_ALIASES live in shared_state_normalization.py
# (repo root) so keyword_search.py resolves the same aliases.
